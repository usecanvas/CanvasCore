...
class URLHelperTests: XCTestCase {
	func testMatching() {
		let url = URL(string: "https://usecanvas.com/about/canvas/55h8GVkBfi5Lnr2Becv5tB")!
		XCTAssertEqual("55h8GVkBfi5Lnr2Becv5tB", URLHelper.canvasID(url: url))
	}

	func testExtension() {
		let url = URL(string: "https://usecanvas.com/about/canvas/55h8GVkBfi5Lnr2Becv5tB.json")!
